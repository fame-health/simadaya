...
<head>
    ...
    <title>Lupa Password - SIMADAYA</title>
        ...
        <div class="relative hidden lg:flex w-full lg:w-3/5 items-center justify-center p-8 lg:p-12 overflow-hidden min-h-screen">
            ...
            <div class="relative z-10 text-center lg:text-left max-w-xl animate-fade-in">
                ...
                <p class="text-xl lg:text-2xl text-emerald-50 font-medium opacity-90 mb-6">
                    Pemulihan Akses Akun Sistem Magang Dinas Kebudayaan
                </p>
        ...
        <div class="w-full lg:w-2/5 flex items-center justify-center p-6 sm:p-12 lg:p-20 bg-gray-50 lg:bg-white">
            <div class="w-full max-w-md animate-fade-in" style="animation-delay: 0.2s;">
                <div class="mb-10 text-center lg:text-left">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">Lupa Kata Sandi?</h2>
                    <p class="text-gray-500 font-medium text-base leading-relaxed">
                        Jangan khawatir. Cukup beri tahu kami alamat email Anda dan kami akan mengirimkan tautan reset kata sandi untuk memilih yang baru.
                    </p>
                </div>
                ...
                @if ($errors->any())
                    <div class="mb-6 p-4 rounded-xl bg-red-50 text-red-700 text-sm font-medium border border-red-100 flex items-center gap-2">
                        ...
                        {{ __('Terjadi masalah. Pastikan email yang Anda masukkan benar.') }}
                    </div>
                @endif
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                    ...
                    <div class="text-center mt-8">
                        <a href="{{ route('login') }}" class="inline-flex items-center gap-2 text-sm font-bold text-emerald-600 hover:text-emerald-700 transition-colors group">
